...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feowl_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('source', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('parsed', self.gf('django.db.models.fields.PositiveIntegerField')(default=2)),
        ))
        db.send_create_signal('feowl', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('feowl_message')
