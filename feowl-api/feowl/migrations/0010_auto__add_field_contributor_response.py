...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contributor.response'
        db.add_column('feowl_contributor', 'response',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contributor.response'
        db.delete_column('feowl_contributor', 'response')
