...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contributor.frequency'
        db.add_column('feowl_contributor', 'frequency',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contributor.frequency'
        db.delete_column('feowl_contributor', 'frequency')
