...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contributor.total_response'
        db.add_column('feowl_contributor', 'total_response',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Contributor.total_enquiry'
        db.add_column('feowl_contributor', 'total_enquiry',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'PowerReport.happened_at'
        db.alter_column('feowl_powerreport', 'happened_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'Contributor.total_response'
        db.delete_column('feowl_contributor', 'total_response')

        # Deleting field 'Contributor.total_enquiry'
        db.delete_column('feowl_contributor', 'total_enquiry')


        # Changing field 'PowerReport.happened_at'
        db.alter_column('feowl_powerreport', 'happened_at', self.gf('django.db.models.fields.DateTimeField')())
