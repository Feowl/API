...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.device'
        db.add_column('feowl_message', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feowl.Device'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.device'
        db.delete_column('feowl_message', 'device_id')
